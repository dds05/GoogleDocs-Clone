...
function Header() {
    ...
    return (
        <header className='sticky top-0 z-50 flex items-center px-4 py-2 shadow-md bg-white'>
            ...
            <Icon 
            name="description" size="5xl"
            color="blue"/>
            <h1 className="hidden md:inline ml-2 text-gray-700 text-2xl">
            Docs
            </h1>
            ...
            focus-within:text-gray-600 focus-within:shadow-md'>
                ...
                <input className='w-6 flex-grow px-5 text-base bg-transparent outline-none
