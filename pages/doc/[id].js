        ...
        <div>
            <header className=' flex justify-between items-center p-3 pb-1'>
                ...
                <div className='flex-grow px-2'>
                    ...
                    <div className='flex items-center text-sm space-x-4 ml-1 h-8 text-gray-600'>
                ...
                <img className='hidden md:inline rounded-full cursor-pointer h-10 w-10 ml-2   ' src={session.user.image} alt=""/>
